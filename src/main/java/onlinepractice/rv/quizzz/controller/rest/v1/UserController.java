...
import onlinepractice.rv.quizzz.service.usermanagement.RegistrationService;
import onlinepractice.rv.quizzz.service.usermanagement.UserManagementService;
...
public class UserController {
	...
	@PreAuthorize("permitAll()")
	@ResponseStatus(HttpStatus.OK)
	public void logoutDummy(@AuthenticationPrincipal AuthenticatedUser authenticatedUser) {
		// Dummy endpoint to point Spring Security to
		logger.debug("Logged out Dummy ");
