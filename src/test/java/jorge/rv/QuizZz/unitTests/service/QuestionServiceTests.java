...
import onlinepractice.rv.quizzz.service.QuestionServiceImpl;
...
public class QuestionServiceTests {
	...
	@Test
	public void testCheckAnswer_answersFound_shouldReturnCorrect() {
		//Answer correctAnswer = new Answer();
		//correctAnswer.setId(1l);
		//question.setCorrectAnswer(correctAnswer);
		question.setIsMorethenOneCorrect(true);
		question.setMultipleCorrectAnswers("1,2,3");
		question.setIsValid(true);

		List<Long> answer_ids = new ArrayList<Long>();
		answer_ids.add(1l);answer_ids.add(2l);answer_ids.add(3l);
		
		boolean isCorrect = service.checkIsCorrectAnswers(question,answer_ids );
